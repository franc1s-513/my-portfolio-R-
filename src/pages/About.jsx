...
const styles = {
  ...
  fuelInline: { display: 'flex', alignItems: 'center', gap: '20px', padding: '20px', background: 'rgba(255,255,255,0.55)', border: '1px solid rgba(0,0,0,0.12)', borderRadius: '16px', maxWidth: '300px' },
  fuelIcon: { color: '#000000' },
  fuelQuote: { margin: 0, fontSize: '0.8rem', opacity: 0.7, fontFamily: 'monospace', color: '#000000' },

  storySection: { marginBottom: '80px' },
  storyGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '26px' },
  storyCard: { background: 'rgba(255, 255, 255, 0.55)', border: '1px solid rgba(255, 255, 255, 0.7)', borderRadius: '24px', padding: '36px 30px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', backdropFilter: 'blur(16px)', boxShadow: '0 10px 30px rgba(0,0,0,0.15)', transition: 'all 0.3s ease', cursor: 'pointer', position: 'relative', overflow: 'hidden' },
  cardHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '22px' },
  cardBadge: { fontSize: '0.78rem', fontWeight: '900', background: 'rgba(14, 165, 233, 0.15)', color: '#0369a1', padding: '6px 14px', borderRadius: '50px', letterSpacing: '1.5px', fontFamily: "'Outfit', 'Inter', sans-serif'" },
  cardIconWrapper: { width: '46px', height: '46px', borderRadius: '14px', background: 'rgba(255, 255, 255, 0.6)', border: '1px solid rgba(0,0,0,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  cardSubtitle: { fontSize: '1.35rem', fontWeight: '850', color: '#000000', margin: '0 0 16px 0', fontFamily: "'Outfit', 'Inter', sans-serif'", letterSpacing: '-0.5px' },
  storyIndex: { fontSize: '0.85rem', fontWeight: '900', color: '#0369a1', letterSpacing: '2px', marginBottom: '12px', fontFamily: "'Outfit', 'Inter', sans-serif'", textTransform: 'uppercase' },
  storyBody: { fontSize: '1.05rem', lineHeight: '1.75', color: 'rgba(0, 0, 0, 0.82)', margin: '0 0 24px 0', fontWeight: '400', flex: 1 },
  highlightText: { color: '#0369a1', fontWeight: '700' },
  cardFooter: { borderTop: '1px solid rgba(0, 0, 0, 0.1)', paddingTop: '16px', display: 'flex', alignItems: 'center' },
  cardMeta: { fontSize: '0.8rem', fontFamily: 'monospace', color: 'rgba(0, 0, 0, 0.55)', fontWeight: '600' },

  objectiveSection: { display: 'grid', gridTemplateColumns: '1fr 280px', gap: '50px', alignItems: 'center', background: 'rgba(255, 255, 255, 0.5)', padding: '50px', borderRadius: '24px', border: '1px solid rgba(255, 255, 255, 0.7)', marginBottom: '90px' },
  objectiveContent: {},
  photoContainer: { display: 'flex', justifyContent: 'center' },
  photoShape: { width: '240px', height: '240px', borderRadius: '20px', background: 'rgba(255, 255, 255, 0.5)', border: '1px solid rgba(0,0,0,0.15)', overflow: 'hidden', boxShadow: '0 20px 40px rgba(0,0,0,0.25)' },

  sectionHeading: { fontSize: 'clamp(2rem, 4.5vw, 2.8rem)', fontWeight: '900', color: '#000000', margin: '0 0 10px 0', fontFamily: "'Outfit', 'Inter', sans-serif'", letterSpacing: '-1px' },

  marqueeContainer: { overflow: 'hidden', padding: '28px 0', borderTop: '1px solid rgba(0,0,0,0.1)', borderBottom: '1px solid rgba(0,0,0,0.1)' },
  techPill: { fontFamily: 'monospace', fontSize: '1.8rem', fontWeight: 'bold', color: 'rgba(0,0,0,0.35)' }, 
  iconPill: { color: 'rgba(0,0,0,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  ...
  vLineActive: { position: 'absolute', left: 0, top: 0, bottom: 0, width: '2px', background: '#0369a1' },
  ...
  tYear: { fontWeight: 'bold', fontFamily: 'monospace', color: '#0369a1', fontSize: '1.2rem' },
  ...
  projectBtn: { marginTop: '22px', padding: '14px 28px', borderRadius: '50px', border: '1px solid #0369a1', background: 'rgba(14, 165, 233, 0.15)', color: '#0369a1', fontFamily: 'monospace', fontWeight: 'bold', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '10px', transition: '0.3s' },

  statusBar: { position: 'relative', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '40px 0 20px', borderTop: '1px solid rgba(0, 0, 0, 0.12)', fontFamily: 'monospace', fontSize: '0.65rem', color: '#000000', marginTop: '60px' },
  ...
  statusLink: { color: '#000000', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '7px', fontWeight: '600' },
};
